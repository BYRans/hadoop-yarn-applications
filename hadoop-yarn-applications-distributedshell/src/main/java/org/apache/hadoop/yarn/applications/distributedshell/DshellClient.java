 ...
 * the {@link DshellApplicationMaster} is launched. </p>
 *
 * <p> The {@link ContainerLaunchContext} in this scenario defines the resources to be allocated for the 
 * {@link DshellApplicationMaster}'s container, the local resources (jars, configuration files) to be made available
 * and the environment to be set for the {@link DshellApplicationMaster} and the commands to be executed to run the
 * {@link DshellApplicationMaster}. <p>
 *
...
public class DshellClient {
    ...
    public DshellClient(Configuration conf) throws Exception {
        ...
        this(
                "org.apache.hadoop.yarn.applications.distributedshell.DshellApplicationMaster",
                conf);
        // ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    }
    ...
    public boolean init(String[] args) throws ParseException {
        ...
        if (cliParser.hasOption("log_properties")) {
            ...
            try {
                Log4jPropertyHelper.updateLog4jConfiguration(DshellClient.class, log4jPath);
            } catch (Exception e) {
    ...
    public boolean run() throws IOException, YarnException {
        ...
        if (domainId != null && domainId.length() > 0) {
            env.put(DshellDSConstants.DISTRIBUTEDSHELLTIMELINEDOMAIN, domainId); // 新版本增加了timeline，timeline用处以及是否需要进行调整，待调研。
        }
